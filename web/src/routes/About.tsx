    ...
    <>
      ...
      <div class="two">
        <section>
          ...
          <h2 style="font-size:1.05rem;margin-top:22px">ป้ายหมวดหมู่</h2>
          <p>
            ป้ายสามแกน (เรื่องอะไร · ทำอะไร · ใครออก) มาจาก rule ที่อ่านผู้ออก ชื่อเรื่อง ประเภทเอกสาร
            และตอนของราชกิจจาฯ — ไม่ใช่ machine learning ป้ายที่ <b>ยืนยัน ✓</b>{' '}
            คือป้ายที่มีหลักฐานเชิงโครงสร้างหรือสองแหล่งอิสระ ป้ายที่ขึ้นว่า{' '}
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>ความแม่นของป้ายที่ยืนยัน</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <section>
          ...
          <p>
            นับเฉพาะป้ายที่ยืนยัน หัวข้อลูกนับรวมเข้าหัวข้อแม่ (ขยะ ⊂ มลพิษ ⊂ สิ่งแวดล้อม) "กฎใหม่" = การกระทำ
